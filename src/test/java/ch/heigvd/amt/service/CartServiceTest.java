...
public class CartServiceTest {
    ...
    void addProductExist() {
        // Check for duplicate
        Assertions.assertEquals(new UpdateResult(UpdateStatus.DUPLICATE), cartService.addProduct(USERNAME, PRODUCT_1));
    ...
    void updateProductQuantity() {
        Assertions.assertEquals(UpdateResult.success(),
                cartService.updateProductQuantity(USERNAME, "1", 11));
        List<CartProduct> result1 = cartService.getAllProduct(USERNAME);
